...
namespace DeliveryCo.Services
{
    public class DeliveryService : IDeliveryService
    {
        ...
        public void SubmitDelivery(DeliveryInfo pDeliveryInfo, IDictionary<int, string> wareHouseList)
        {
                DeliveryProvider.SubmitDelivery(
                MessageTypeConverter.Instance.Convert<DeliveryCo.MessageTypes.DeliveryInfo, 
                DeliveryCo.Business.Entities.DeliveryInfo>(pDeliveryInfo), wareHouseList                
            );
        }
    }
}
