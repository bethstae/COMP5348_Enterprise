...
namespace BookStore.WebClient.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        //GET: /Account/Orders
       [AllowAnonymous]
        public ActionResult Orders( UserCache pUser)
        {
            
            return View(new OrdersViewModel(pUser.Model));
        }

        public RedirectToRouteResult CancelOrder(Order pOrder, string pReturnUrl)
        {
            ServiceFactory.Instance.OrderService.CancelOrder(pOrder);
            return RedirectToAction("RefundSuccessPage");
        }

        public ActionResult RefundSuccessPagee()
        {
            return View();
        }
